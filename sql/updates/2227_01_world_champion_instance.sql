ALTER TABLE version CHANGE COLUMN required_2219_01_world_changes_330 required_2227_01_world_champion_instance bit;

-- instance
UPDATE instance_template SET script='instance_trial_champion' WHERE map=650;
