...
char serviceName[] = "Logon";
char serviceLongName[] = "Logon Services";
...
extern int main(int argc, char **argv)
{
    ...
    sLogonList.Initialize(sConfig.GetIntDefault("RealmsStateUpdateDelay", 20));
    if (sLogonList.size() == 0)
    {
    ...
    #ifdef WIN32
    {
        ...
        if (Prio)
        {
            if (SetPriorityClass(hProcess,HIGH_PRIORITY_CLASS))
                sLog.outString("Logon process priority class set to HIGH");
            else
