...
extern void AddSC_npc_playermaster();
...
extern void AddSC_instance_culling_of_stratholme(); //culling of Stratholme
extern void AddSC_boss_epoch();
extern void AddSC_boss_infinite();
...
extern void AddSC_boss_argent_challenge();      //Crusaders' Coliseum, Trial of the Champion
extern void AddSC_boss_black_knight();
extern void AddSC_boss_grand_champions();
extern void AddSC_instance_trial_champion();
extern void AddSC_trial_champion();
extern void AddSC_instance_trial_crusader();    //Crusaders' Coliseum, Trial of the Crusader
...
void AddScripts()
{
    ...
    AddSC_instance_culling_of_stratholme(); //culling of Stratholme
    AddSC_boss_epoch();
    AddSC_boss_infinite();
    ...
    AddSC_boss_argent_challenge();      //Crusaders' Coliseum, Trial of the Champion
    AddSC_boss_black_knight();
    AddSC_boss_grand_champions();
    AddSC_instance_trial_champion();
    AddSC_trial_champion();
    AddSC_instance_trial_crusader();    //Crusaders' Coliseum, Trial of the Crusader
