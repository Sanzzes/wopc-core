...
struct SCRIPTS_DLL_DECL npc_gurgthockAI : public ScriptedAI
{
...
struct SCRIPTS_DLL_DECL npc_orinoko_tuskbreakerAI : public ScriptedAI
{
    ...
    void EnterEvadeMode()
    {
        ...
        if (m_creature && m_creature->isSummon())
...
struct SCRIPTS_DLL_DECL npc_korrak_bloodragerAI : public ScriptedAI
{
...
struct SCRIPTS_DLL_DECL npc_yggdrasAI : public ScriptedAI
{
