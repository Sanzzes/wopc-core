...
struct SCRIPTS_DLL_DECL boss_sjonnirAI : public ScriptedAI
{
    ...
    void JustDied(Unit* killer)
    {
        ...
        if (pInstance)
        {
            ...
            if (!RegularMode && uiKilledIronSludges > 4)
...
struct SCRIPTS_DLL_DECL mob_malformed_oozeAI : public ScriptedAI
{
...
struct SCRIPTS_DLL_DECL mob_iron_sludgeAI : public ScriptedAI
{
