...
{
    instance_ulduar(Map* pMap) : ScriptedInstance(pMap), KologarnChest(NULL), ThorimChest(NULL), HodirChest(NULL), FreyaChest(NULL), AlgalonChest(NULL), MimironChest(NULL) { Initialize(); };
    ...
    GameObject* KologarnChest, *ThorimChest, *HodirChest, *FreyaChest, *AlgalonChest, *MimironChest;
