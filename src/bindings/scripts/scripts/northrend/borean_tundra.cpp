...
struct SCRIPTS_DLL_DECL npc_scourge_prisonerAI : public ScriptedAI
{
...
struct SCRIPTS_DLL_DECL npc_jennyAI : public ScriptedAI
{
...
struct SCRIPTS_DLL_DECL npc_nesingwary_trapperAI : public ScriptedAI
{
...
struct SCRIPTS_DLL_DECL npc_lurgglbrAI : public npc_escortAI
{
...
struct SCRIPTS_DLL_DECL npc_nexus_drake_hatchlingAI : public FollowerAI //The spell who makes the npc follow the player is missing, also we can use FollowerAI!
{
...
struct SCRIPTS_DLL_DECL npc_beryl_sorcererAI : public FollowerAI
{
...
struct SCRIPTS_DLL_DECL npc_imprisoned_beryl_sorcererAI : public ScriptedAI
{
