...
struct SCRIPTS_DLL_DECL boss_novosAI : public Scripted_NoMovementAI
{
...
struct SCRIPTS_DLL_DECL mob_crystal_handlerAI : public ScriptedAI
{
...
struct SCRIPTS_DLL_DECL mob_novos_minionAI : public ScriptedAI
{
