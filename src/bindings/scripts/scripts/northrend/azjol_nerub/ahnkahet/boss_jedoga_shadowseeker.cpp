...
struct SCRIPTS_DLL_DECL boss_jedoga_shadowseekerAI : public ScriptedAI
{
...
struct SCRIPTS_DLL_DECL mob_jedoga_initiandAI : public ScriptedAI
{
...
struct SCRIPTS_DLL_DECL npc_jedogas_aufseher_triggerAI : public Scripted_NoMovementAI
{
