...
// Eadric The Pure
struct SCRIPTS_DLL_DECL boss_eadricAI : public ScriptedAI
{
	...
	void EnterEvadeMode()
	{
		...
		m_creature->SendMonsterMove(746.864441, 660.918762, 411.695465, 4.698700, m_creature->GetUnitMovementFlags(), 1);
...
struct SCRIPTS_DLL_DECL boss_paletressAI : public ScriptedAI
{
...
// Summoned Memory
struct SCRIPTS_DLL_DECL mob_toc5_memoryAI : public ScriptedAI
{
