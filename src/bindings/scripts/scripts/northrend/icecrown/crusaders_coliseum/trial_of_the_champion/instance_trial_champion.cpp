...
struct SCRIPTS_DLL_DECL instance_trial_champion : public ScriptedInstance
{
    instance_trial_champion(Map* pMap) : ScriptedInstance(pMap) {Initialize();}
...
InstanceData* GetInstanceData_instance_trial_champion(Map* pMap)
{
    return new instance_trial_champion(pMap);
}

void AddSC_instance_trial_champion()
{
    Script *newscript;
    newscript = new Script;
    newscript->Name = "instance_trial_champion";
    newscript->GetInstanceData = &GetInstanceData_instance_trial_champion;
