...
#include "trial_champion.h"

enum eGrandChampions
{
	//yells
...
// Warrior
struct SCRIPTS_DLL_DECL mob_toc5_warriorAI : public ScriptedAI
{
	...
	void EnterEvadeMode()
	{
		if (Creature* pTemp = ((Creature*)Unit::GetUnit((*m_creature), m_pInstance->GetData64(DATA_CHAMPION_1))))
			...
			{
				pTemp->Respawn();
				pTemp->SendMonsterMove(738.665771, 661.031433, 412.394623, 4.698702, pTemp->GetUnitMovementFlags(), 1);
		...
		if (Creature* pTemp = ((Creature*)Unit::GetUnit((*m_creature), m_pInstance->GetData64(DATA_CHAMPION_2))))
			...
			{
				pTemp->Respawn();
				pTemp->SendMonsterMove(746.864441, 660.918762, 411.695465, 4.698700, pTemp->GetUnitMovementFlags(), 1);
		...
		if (Creature* pTemp = ((Creature*)Unit::GetUnit((*m_creature), m_pInstance->GetData64(DATA_CHAMPION_3))))
			...
			{
				pTemp->Respawn();
				pTemp->SendMonsterMove(754.360779, 660.816162, 412.395996, 4.698700, pTemp->GetUnitMovementFlags(), 1);
...
// Mage
struct SCRIPTS_DLL_DECL mob_toc5_mageAI : public ScriptedAI
{
...
// Shaman
struct SCRIPTS_DLL_DECL mob_toc5_shamanAI : public ScriptedAI
{
...
// Hunter
struct SCRIPTS_DLL_DECL mob_toc5_hunterAI : public ScriptedAI
{
...
// Rogue
struct SCRIPTS_DLL_DECL mob_toc5_rogueAI : public ScriptedAI
{
