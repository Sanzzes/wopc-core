...
#define SPELL_CARNIVOROUSBITE       (RegularMode?H_SPELL_CARNIVOROUSBITE:N_SPELL_CARNIVOROUSBITE)

#define ENTRY_FOCUS_FIRE            18374

#define N_SPELL_FIERY_BLAST         32302
#define H_SPELL_FIERY_BLAST         38382
#define SPELL_FIERY_BLAST           (RegularMode?H_SPELL_FIERY_BLAST:N_SPELL_FIERY_BLAST)
