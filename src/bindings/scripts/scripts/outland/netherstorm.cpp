...
//TODO: clean up this workaround when Ixilium adds support to do it properly (with gossip selections instead of instant summon)
...
struct SCRIPTS_DLL_DECL npc_commander_dawnforgeAI : public ScriptedAI
{
    ...
    bool CanStartEvent(Player* pPlayer)
    {
        ...
        debug_log("ISCR: npc_commander_dawnforge event already in progress, need to wait.");
        return false;
    }
