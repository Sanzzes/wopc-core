...
#define SPELL_FIREBALL              (RegularMode?36920:34653)
#define SPELL_CONE_OF_FIRE          (RegularMode?36921:30926)
#define SPELL_SUMMON_LIQUID_FIRE    (RegularMode?30928:23971)
#define SPELL_BELLOWING_ROAR        39427
#define SPELL_REVENGE               (RegularMode?40392:19130)
...
#define ENTRY_REINFORCED_FEL_IRON_CHEST (RegularMode?185169:185168)
...
struct SCRIPTS_DLL_DECL boss_nazanAI : public ScriptedAI
{
    ...
    void UpdateAI(const uint32 diff)
    {
        ...
        else // phase 2 - land fight
        {
            ...
            if (!RegularMode && BellowingRoar_Timer <= diff)
            {
