...
SDName: Boss_Gruul
SD%Complete: 60
SDComment: Ground Slam need further development (knock back effect and shatter effect must be added to ixiliumemu)
...
struct SCRIPTS_DLL_DECL boss_gruulAI : public ScriptedAI
{
    ...
    void SpellHitTarget(Unit* pTarget, const SpellEntry* pSpell)
    {
        ...
        //this part should be in ixiliumemu
        if (pSpell->Id == SPELL_SHATTER)
        {
            //this spell must have custom handling in ixiliumemu, dealing damage based on distance
