...
struct SCRIPTS_DLL_DECL npc_time_riftAI : public ScriptedAI
{
    ...
    void DoSelectSummon()
    {
        ...
        debug_log("ISCR: npc_time_rift: summoning wave Creature (Wave %u, Entry %u).",mRiftWaveCount,entry);
    ...
    void UpdateAI(const uint32 diff)
    {
        ...
        debug_log("ISCR: npc_time_rift: not casting anylonger, i need to die.");
