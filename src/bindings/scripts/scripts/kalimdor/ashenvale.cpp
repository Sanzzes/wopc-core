...
bool QuestAccept_npc_torek(Player* pPlayer, Creature* pCreature, Quest const* quest)
{
    ...
    {
        //TODO: find companions, make them follow Torek, at any time (possibly done by ixiliumemu/database in future?)
...
struct SCRIPTS_DLL_DECL npc_muglashAI : public npc_escortAI
{
