...
struct SCRIPTS_DLL_DECL npc_lord_gregor_lescovarAI : public npc_escortAI
{
...
struct SCRIPTS_DLL_DECL npc_marzon_silent_bladeAI : public ScriptedAI
{
...
struct SCRIPTS_DLL_DECL npc_tyrion_spybotAI : public npc_escortAI
{
