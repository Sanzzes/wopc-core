...
struct SCRIPTS_DLL_DECL instance_blackrock_depths : public ScriptedInstance
{
    ...
    {
        debug_log("ISCR: Instance Blackrock Depths: SetData64 update (Type: %u Data %u)", type, data);
    ...
    {
        debug_log("ISCR: Instance Blackrock Depths: SetData update (Type: %u Data %u)", type, data);
