...
#ifndef WOPCCOREEMU_GOSSIP_H
#define WOPCCOREEMU_GOSSIP_H
...
enum Gossip_Option
{
    ...
    GOSSIP_OPTION_OUTDOORPVP        = 19,                   //UNIT_NPC_FLAG_TRAINER             (16) (added by code (option for outdoor pvp creatures)
    GOSSIP_OPTION_MAX
};
...
class WOPCCORE_DLL_SPEC GossipMenu
{
    public:
        GossipMenu();
        ~GossipMenu();
...
class WOPCCORE_DLL_SPEC PlayerMenu
{
    private:
