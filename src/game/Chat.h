...
class IXILIUM_DLL_SPEC ChatHandler
{
    ...
    protected:
        ...
        bool HandleBroadcastAddCommand(const char* args);
        bool HandleBroadcastEditCommand(const char* args);
        bool HandleBroadcastDeleteCommand(const char* args);
        ...
        bool HandleReloadPoiCommand(const char* args);
