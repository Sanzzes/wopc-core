...
enum IxiliumStrings
{
    ...
    LANG_NPCINFO_SHOW_SCRIPTNAME                       = 573,
    //                                                   574,    //not used
    ...
    LANG_BG_WG_BATTLE_STARTS                           = 616,
    LANG_BG_WG_DEFENDED                                = 617,
    LANG_BG_WG_CAPTURED                                = 618,
    LANG_BG_WG_WORKSHOP_DAMAGED                        = 619,
    LANG_BG_WG_WORKSHOP_DESTROYED                      = 620,
    LANG_BG_WG_TOWER_DAMAGED                           = 621,
    LANG_BG_WG_TOWER_DESTROYED                         = 622,
    LANG_BG_WG_FORTRESS_UNDER_ATTACK                   = 623,
    LANG_BG_WG_SWITCH_FACTION                          = 624,
    LANG_BG_WG_CHANGE_TIMER                            = 625,
    LANG_BG_WG_BATTLE_FORCE_START                      = 626,
    LANG_BG_WG_BATTLE_FORCE_STOP                       = 627,
    LANG_BG_WG_STATUS                                  = 628,
    LANG_BG_WG_DISABLE                                 = 629,
    LANG_BG_WG_ENABLE                                  = 630,
    LANG_BG_WG_RANK1                                   = 631,
    LANG_BG_WG_RANK2                                   = 632,
    //
    // More Room for Battleground                      = 632-635
    //
    ...
    LANG_BG_SA_START_HALF_MINUTE                       = 688,
    LANG_BG_SA_HAS_BEGUN                               = 689,
    // 688 - 699 not used
    ...
    LANG_ARENA_TESTING                                 = 791,
    LANG_AUTO_ANN                                      = 792,
    LANG_ANNOUNCE_COLOR                                = 793,
    LANG_BG_IC_START_TWO_MINUTES                       = 794,
    LANG_BG_IC_START_ONE_MINUTE                        = 795,
    LANG_BG_IC_START_HALF_MINUTE                       = 796,
    LANG_BG_IC_HAS_BEGUN                               = 797,
    LANG_BG_SA_START_TWO_MINUTES                       = 798,
    LANG_BG_SA_START_ONE_MINUTE                        = 799,
    ...
    LANG_JAIL_YOURE_UNJAILED                           = 821,  // "You was released out of the jail by %s."
    LANG_JAIL_WAS_UNJAILED                             = 822,  // "You have released %s out of the jail."
    LANG_JAIL_NOREASON                                 = 823,  // "No reason given or reason is < %u chars!"
    LANG_JAIL_NONAME                                   = 824,  // "No name given!"
    LANG_JAIL_NOTIME                                   = 825,  // "No time given!"
    LANG_JAIL_VALUE                                    = 826,  // "The jailtime must be between 1 and %u hours!"
    LANG_JAIL_CHAR_NOTJAILED                           = 827,  // "The character (%s) is not jailed!"
    LANG_JAIL_DENIED                                   = 828,  // "Command forbidden for jailed characters!"
    LANG_JAIL_JAILED_H_INFO                            = 829,  // "You have %u hour(s) left in the jail."
    LANG_JAIL_JAILED_M_INFO                            = 830,  // "You have %u minute(s) left in the jail."
    LANG_JAIL_NOTJAILED_INFO                           = 831,  // "You're a free woman / man. ;-)"
    LANG_JAIL_GM_INFO                                  = 832,  // "%s was %u times jailed and has %u minute(s) left. Last time jailed by %s. Last reason was: '%s'"
    LANG_JAIL_GM_NOINFO                                = 833,  // "%s was never jailed."
    LANG_JAIL_NO_JAIL                                  = 834,  // "You can't jail yourself!"
    LANG_JAIL_NO_UNJAIL                                = 835,  // "You can't unjail yourself!"
    LANG_JAIL_WARNING                                  = 836,  // "Be carefull! Only one more jailtime and your current character will be deleted!"
    LANG_JAIL_ANNOUNCE1                                = 837,  // "The character '"
    LANG_JAIL_ANNOUNCE2                                = 838,  // "' was jailed for "
    LANG_JAIL_ANNOUNCE3                                = 839,  // " hour(s) by the GM character '"
    LANG_JAIL_ANNOUNCE4                                = 840,  // "'. The reason is: "
    LANG_JAIL_RELOAD                                   = 841,  // "The jail configuration was reloaded."
    LANG_JAIL_CONF_LOADED                              = 842,  // ">> Jail config loaded."
    LANG_JAIL_CONF_ERR1                                = 843,  // "Can't load jail config! Table empty or missed! Use jail_conf.sql!"
    LANG_JAIL_CONF_ERR2                                = 844,  // "Set all jail config settings to default..."
    LANG_JAIL_CHAR_TELE                                = 845,  // "The Character '%s' (GUID %u) is jailed and teleportet into the jail."
    LANG_JAIL_CHAR_FREE                                = 846,  // "The Character '%s' (GUID %u) was released out of the jail."
    LANG_JAIL_WRONG_NAME                               = 847,  // "A character with this name doesn't exists!"
    LANG_JAIL_WARNING_BAN                              = 848,  // "Be carefull! Only one more jailtime and your account will be banned!"
    LANG_JAIL_BAN_REASON                               = 849,  // "Max. jailtimes reached!"
    LANG_JAIL_BAN_BY                                   = 850,  // "Robotron"
    LANG_JAIL_AMNESTII                                 = 851,  // "AMNESTII"
    // Room for in-game strings                        852-999 not used
    ...
    LANG_BROADCAST_CREATED                             = 1020, 
    LANG_BROADCAST_TOO_LONG                            = 1021, 
    LANG_BROADCAST_ALREADY_EXIST                       = 1022, 
    LANG_BROADCAST_NOT_CREATED_SQL_ERROR               = 1023, 
    LANG_BROADCAST_NOT_CREATED                         = 1024, 
    ...
    //
    // More Room for Level 3 (Part 2)                  = 1132-1199
    //
    ...
    //reserverd for next patches                       = 11001,
    //reserverd for next patches                       = 11002,
    LANG_PINFO_CHARS                                   = 11003,
    LANG_PINFO_ACCOUNT_ACCOUNT                         = 11004,
    LANG_PINFO_CHARACTER                               = 11005,
    LANG_PINFO_IP                                      = 11006,
    LANG_ACCOUNT_NOT_FOUND                             = 11007,
    LANG_CHATLEV_ERROR                                 = 11008,
    ...
    LANG_WORLD_LOAD_ITEM_TEXTS_LOADING                 = 50076, // "Loading Item Texts..."
    LANG_WORLD_LOAD_ITEM_TEXTS_EMPTY                   = 50077, // ">> Loaded 0 item texts"
    LANG_WORLD_LOAD_ITEM_TEXTS_LOADED                  = 50078, // ">> Loaded %u item texts"
    LANG_WORLD_LOAD_CREATURE_MODEL_DATA_LOADING        = 50079, // "Loading Creature Model Based Info Data..."
    LANG_WORLD_LOAD_CREATURE_MODEL_DATA_LOADED         = 50080, // ">> Loaded %u creature model based info"
    LANG_WORLD_LOAD_EQUIPMENT_TEMPLATES_LOADING        = 50081, // "Loading Equipment templates..."
    LANG_WORLD_LOAD_EQUIPMENT_TEMPLATES_LOADED         = 50082, // ">> Loaded %u equipment template"
    LANG_WORLD_LOAD_CREATURE_TEMPLATES_LOADING         = 50083, // "Loading Creature templates..."
    LANG_WORLD_LOAD_CREATURE_TEMPLATES_LOADED          = 50084, // ">> Loaded %u creature definitions"
    LANG_WORLD_LOAD_SPELL_SCRIPT_TARGET_LOADING        = 50085, // "Loading SpellsScriptTarget..."
    LANG_WORLD_LOAD_SPELL_SCRIPT_TARGET_EMPTY          = 50086, // ">> Loaded 0 SpellScriptTarget. DB table `spell_script_target` is empty."
    LANG_WORLD_LOAD_SPELL_SCRIPT_TARGET_LOADED         = 50087, // ">> Loaded %u Spell Script Targets"
    LANG_WORLD_LOAD_ITEM_REQUIRED_TARGET_LOADING       = 50088, // "Loading ItemRequiredTarget..."
    LANG_WORLD_LOAD_ITEM_REQUIRED_TARGET_LOADED        = 50089, // ">> Loaded %u Item required targets"
    LANG_WORLD_LOAD_CREATURE_REPU_ONKILL_LOADING       = 50090, // "Loading Creature Reputation OnKill Data..."
    LANG_WORLD_LOAD_CREATURE_REPU_ONKILL_LOADED        = 50091, // ">> Loaded %u creature award reputation definitions"
    LANG_WORLD_LOAD_POINTS_OF_INTEREST_DATA_LOADING    = 50092, // "Loading Points Of Interest Data..."
    LANG_WORLD_LOAD_POINTS_OF_INTEREST_DATA_LOADED     = 50093, // ">> Loaded %u Points of Interest definitions"
    LANG_WORLD_LOAD_CREATURE_DATA_LOADING              = 50094, // "Loading Creature Data..."
    LANG_WORLD_LOAD_CREATURE_DATA_LOADED               = 50095, // ">> Loaded %lu creatures"
    LANG_WORLD_LOAD_CREATURE_LINKED_RESPAWN_LOADING    = 50096, // "Loading Creature Linked Respawn..."
    LANG_WORLD_LOAD_CREATURE_LINKED_RESPAWN_LOADED     = 50097, // ">> Loaded %u linked respawns"
    LANG_WORLD_LOAD_PET_LEVELUP_SPELLS_LOADING         = 50098, // "Loading pet levelup spells..."
    LANG_WORLD_LOAD_PET_LEVELUP_SPELLS_LOADED          = 50099, // ">> Loaded %u pet levelup and default spells for %u families"
    LANG_WORLD_LOAD_PET_DEFAULT_LEVELUP_SPELLS_LOADING = 50100, // "Loading pet default spell additional to levelup spells..."
    LANG_WORLD_LOAD_PET_DEFAULT_LEVELUP_SPELLS_LOADED  = 50101, // ">> Loaded addition spells for %u pet spell data entries and %u summonable creature templates"
    LANG_WORLD_LOAD_CREATURE_ADDON_DATA_LOADING        = 50102, // "Loading Creature Addon Data..."
    LANG_WORLD_LOAD_CREATURE_ADDON_DATA_LOADED         = 50103, // ">> Creature Addon Data loaded"
    LANG_WORLD_LOAD_CREATURE_RESPAWN_DATA_LOADING      = 50104, // "Loading Creature Respawn Data..."
    LANG_WORLD_LOAD_CREATURE_RESPAWN_DATA_EMPTY        = 50105, // ">> Loaded 0 creature respawn time."
    LANG_WORLD_LOAD_CREATURE_RESPAWN_DATA_LOADED       = 50106, // ">> Loaded %lu creature respawn times"
    LANG_WORLD_LOAD_GAMEOBJECT_DATA_LOADING            = 50107, // "Loading Gameobject Data..."
    LANG_WORLD_LOAD_GAMEOBJECT_DATA_LOADED             = 50108, // ">> Loaded %lu gameobjects"
    LANG_WORLD_LOAD_GAMEOBJECT_RESPAWN_TIMES_LOADING   = 50109, // "Loading Gameobject Respawn Times..."
    LANG_WORLD_LOAD_GAMEOBJECT_RESPAWN_TIMES_EMPTY     = 50110, // ">> Loaded 0 gameobject respawn times."
    LANG_WORLD_LOAD_GAMEOBJECT_RESPAWN_TIMES_LOADED    = 50111, // ">> Loaded %lu gameobject respawn times"
