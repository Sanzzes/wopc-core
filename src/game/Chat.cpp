...
ChatCommand * ChatHandler::getCommandTable()
{
    ...
    {
        { "add",                         SEC_GAMEMASTER,    true,  &ChatHandler::HandleBroadcastAddCommand,                                 "", NULL },
        { "edit",                        SEC_GAMEMASTER,    true,  &ChatHandler::HandleBroadcastEditCommand,                                "", NULL },
        { "delete",                      SEC_ADMINISTRATOR, true,  &ChatHandler::HandleBroadcastDeleteCommand,                              "", NULL },
        { "list",                        SEC_GAMEMASTER,    true,  &ChatHandler::HandleBroadcastListCommand,                                "", NULL },
        { NULL,                          0,                 false, NULL,                                                                    "", NULL }
    };
    ...
    static ChatCommand debugCommandTable[] =
    {
        ...
        { "hostile",                     SEC_ADMINISTRATOR, false, &ChatHandler::HandleDebugHostileRefList,                                  "", NULL },
    ...
    static ChatCommand reloadCommandTable[] =
    {
        ...
        { "quest_poi",                   SEC_ADMINISTRATOR, true,  &ChatHandler::HandleReloadPoiCommand,                                    "", NULL },
	...
	static ChatCommand vipCommandTable[] =
	{
        ...
        { "tele",                        SEC_VIP,           false, &ChatHandler::HandleTeleCommand,                                         "", NULL },
        { "gmingame",                    SEC_VIP,           false, &ChatHandler::HandleGMListIngameCommand,                                 "", NULL },
        { NULL,                          0,                 false, NULL,                                                                    "", NULL }
	};
    ...
    static ChatCommand commandTable[] =
    {
        ...
        { "broadcast",                   SEC_MODERATOR,     true,  NULL,                                                                    "", broadcastCommandTable },
