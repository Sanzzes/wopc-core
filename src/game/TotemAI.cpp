...
TotemAI::UpdateAI(const uint32 /*diff*/)
{
    ...
    {
        victim = NULL;
        WOPCCORE::NearestAttackableUnitInObjectRangeCheck u_check(m_creature, m_creature, max_range);
        WOPCCORE::UnitLastSearcher<WOPCCORE::NearestAttackableUnitInObjectRangeCheck> checker(m_creature, victim, u_check);
