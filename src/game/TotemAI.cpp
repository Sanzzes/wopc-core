...
TotemAI::UpdateAI(const uint32 /*diff*/)
{
    ...
    {
        victim = NULL;
        Ixilium::NearestAttackableUnitInObjectRangeCheck u_check(m_creature, m_creature, max_range);
        Ixilium::UnitLastSearcher<Ixilium::NearestAttackableUnitInObjectRangeCheck> checker(m_creature, victim, u_check);
