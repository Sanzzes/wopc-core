...
class IXILIUM_DLL_SPEC Player : public Unit
{
    ...
    public:
        ...
        int32 GetQuestLevelForPlayer(Quest const* pQuest) const { return pQuest && pQuest->GetQuestLevel() > 0 ? (uint32)pQuest->GetQuestLevel() : getLevel(); }
